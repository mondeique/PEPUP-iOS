...
class AlertSettingVC: UIViewController {
    ...
    func setup() {
        ...
        navcontentView.addSubview(alertsettingLabel)
        ...
        alertsettingLabel.topAnchor.constraint(equalTo: navcontentView.topAnchor, constant: screenHeight/defaultHeight * 12).isActive = true
        alertsettingLabel.centerXAnchor.constraint(equalTo: navcontentView.centerXAnchor).isActive = true
    }
