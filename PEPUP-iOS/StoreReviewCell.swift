...
class StoreReviewCell: BaseCollectionViewCell, UICollectionViewDelegate, UICollectionViewDataSource{
    
    private let reviewcellId = "reviewcell"
    private let reviewheaderId = "reviewheadercell"
    ...
    override func setup() {
        ...
        reviewcollectionView.register(ReviewHeaderCell.self, forSupplementaryViewOfKind: UICollectionView.elementKindSectionHeader, withReuseIdentifier: reviewheaderId)
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        switch kind {
            ...
            case UICollectionView.elementKindSectionHeader:
                let headerView = collectionView.dequeueReusableSupplementaryView(ofKind: kind, withReuseIdentifier: reviewheaderId, for: indexPath) as! ReviewHeaderCell
...
class ReviewHeaderCell: BaseCollectionViewCell {
