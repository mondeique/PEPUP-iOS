...
class AccountVC: UIViewController {
    ...
    func setup() {
        ...
        navcontentView.addSubview(accountLabel)
        ...
        accountLabel.topAnchor.constraint(equalTo: navcontentView.topAnchor, constant: screenHeight/defaultHeight * 12).isActive = true
        accountLabel.centerXAnchor.constraint(equalTo: navcontentView.centerXAnchor).isActive = true
    }
