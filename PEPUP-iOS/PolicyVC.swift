...
class PolicyVC: UIViewController {
    ...
    func setup() {
        ...
        navcontentView.addSubview(policyLabel)
        ...
        policyLabel.topAnchor.constraint(equalTo: navcontentView.topAnchor, constant: screenHeight/defaultHeight * 12).isActive = true
        policyLabel.centerXAnchor.constraint(equalTo: navcontentView.centerXAnchor).isActive = true
    }
