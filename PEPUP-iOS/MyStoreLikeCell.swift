...
class MyStoreLikeCell: BaseCollectionViewCell, UICollectionViewDelegate, UICollectionViewDataSource{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: likecellId, for: indexPath) as! MyLikeCell
...
class MyLikeCell: BaseCollectionViewCell {
